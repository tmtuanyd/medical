  ...
  return (
    <AppBar position='relative' sx={{ bgcolor: 'unset' }}>
      <Box display='flex' alignItems={'center'} justifyContent={'space-around'}>
        <Box display='flex' justifyContent={{ xs: 'between', sm: 'center' }} alignItems='center' p={2}>
          <img src={'/assets/images/logo.png'} alt='' style={{ width: '8rem' }} />
        </Box>
        <Box display={{ xs: 'none', sm: 'flex' }} flexDirection={{ xs: 'column', sm: 'row' }} alignItems='center'>
        ...
        <Box display={{ xs: 'flex', sm: 'none' }} position='relative' className={classes.toggleButton}>
          {toggleMenu ? (
